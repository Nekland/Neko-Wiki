...
namespace Nekland\NekoWiki\Model\User;

use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Security\Core\Role\RoleHierarchyInterface;
use Symfony\Component\Security\Core\Role\Role as RoleBase;
 ...
 * @ORM\Table(name="role")
 */
class Role extends RoleBase implements RoleHierarchyInterface, \Serializable
{
    /**
     * @var int
     *
